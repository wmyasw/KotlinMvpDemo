...
import com.wmy.kotlin.mvvm.theme.utils.PreferencesUtils;
...
public class SkinConfig {
	...
	public 	static final String 	PREF_CUSTOM_SKIN_PATH 	= 	"cn_wmy_skin_custom_path";
	public  static final String 	DEFALT_SKIN 			= 	"cn_wmy_skin_default";
	public 	static final String 	SKIN_FROM	 			= 	"cn_wmy_skin_from";
