...
import com.wmy.kotlin.mvvm.theme.SkinManager.Companion.instance

/**
 * @author：@user()
 * @date：$date$ $time$
 */
internal class ColorAttr : SkinItem() {
    var dividerHeight = 1
    override fun apply(view: View) {
        if (view is ListView) {
            ...
            } else if (RES_TYPE_NAME_DRAWABLE == typeName) tv.divider = SkinManager.instance.getDrawable(resId)
        }
    }
}